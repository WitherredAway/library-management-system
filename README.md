...
- For a simpler program using Dictionaries insteade of MySQL, check out [`without-sql`](https://github.com/WitherredAway/library-management-system/tree/without-sql)
